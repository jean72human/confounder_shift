...
for algo in ["ERM","GroupDRO","IRM","CORAL","CausIRL_CORAL","MMD"]:
    for dataset in ["SpuriousLocation1","SpuriousLocation2"]:
        ...
        os.system(f"""python3 -m domainbed.scripts.train_n --data_dir=/home/aengusl/Desktop/Projects/OOD_workshop/Stable_Diffusion_Generation/gen_images/full_folder  --algorithm {algo} --test_env 0 1 --dataset {dataset} --hparams='{hparams}' --seed {args.seed} --output_dir final_output --n_iter 3 --quiet""")